    ...
    <section class="box-price">
        <div class="container">
            <div class="box-price-1">
                <div class="title-price text-center"><?php pll_e( 'Bảng giá Gói Ký hợp đồng, tài liệu điện tử FPT.eContract' ); ?></div>
        ...
        <div class="container">
            <div class="content-form-price">
                ...
                <div class="title-form">
                    <h3><?php the_field('title_form_dk') ?></h3>
                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="inp_field select_field">
                                    <select name="goiphanmem_econtract" class="numb_money" id="numb-1">
                                        ...
                                        <?php $key_1 = 0; ?>
                                            <?php while ( has_sub_field('danh_sach_slide', 'option') ) : ?>
                                                <option id="list<?php echo $key_1++ ?>" value="<?php the_sub_field( 'price_pack' ); ?>"><?php the_sub_field( 'ten_goi' ); ?> - 
                            ...
                            <div class="col-md-6">
                                <ul class="price-button">
                                    <?php while ( has_sub_field('cta_button') ) : ?>
                                        <li>
                                            <input type="submit" value="<?php the_sub_field('cta_dang_ky') ?>" class="btn-price">
                                        </li>
                                        <li>
                                            <div class="hotline-price">
                                                <a href="tel:1900 636 191"><?php the_sub_field('cta_tu_van') ?></a>
                                            </div>
                                        </li>
                                    <?php endwhile; ?>
                                </ul>
